<div class="card card-primary card-outline">
    ...
    <div class="card-body p-3 mailbox-messages">
        ...
        <table class="table table-striped dt-responsive tablaTickets" width="100%">
            ...
            <tbody>
                @foreach ($ticketsRecibidos as $ticket)
                <tr>
                    <td><input type="checkbox" class="checkboxSeleccionar" value="{{ $ticket->id }}"></td>
                    <td>
                        <a href="{{ route('soporte.lectura-ticket', ['id' => $ticket->id, 'origen' => 'recibidos']) }}" class="ver-ticket" data-origen="recibidos" data-id="{{ $ticket->id }}">
                            {{ $ticket->remitenteRelacion->name }}
                        </a>
                    </td>
                    <td>
                        <a href="{{ route('soporte.lectura-ticket', ['id' => $ticket->id, 'origen' => 'recibidos']) }}" class="ver-ticket" data-origen="recibidos" data-id="{{ $ticket->id }}">
